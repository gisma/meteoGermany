...
#gitter=  st_read(paste0(envrmt$path_data_lev0,"/DE_Grid_ETRS89-LAEA_100m.gpkg"))
...
#   mz_haushalte_2011 = as_tibble(data.table::fread(fn[4]))
  ...
  gem_2011 = st_intersection(grid_demo_DE_sf,gemeinden_sf_3035)
